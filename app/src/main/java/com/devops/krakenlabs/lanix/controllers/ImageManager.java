...
public class ImageManager {
    ...
    */
    public static final String storageConnectionString = "DefaultEndpointsProtocol=https;"
            + "AccountName=laniximages;"
            + "AccountKey=E+DQPBozGfkxJwhUxTVWpvpIt7ygHlHFy9oZ/nXEpUe+cGjeg1FzeoXzIga/GWx5DEZPUilR3onReiZdF4EpOw==";
    ...
    public static String UploadImage(InputStream image, int imageLength, String imageName) throws Exception {
        Log.d(TAG, "UploadImage() called with: image = [" + image + "], imageLength = [" + imageLength + "]");
