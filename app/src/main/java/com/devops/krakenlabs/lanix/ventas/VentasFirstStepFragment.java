...
public class VentasFirstStepFragment extends Fragment implements Step,
    DatePickerDialog.OnDateSetListener, HomeActivity.PhotoNotifier {
  ...
  public VerificationError verifyStep() {
    ...
    if (null != image) {
      ...
      ho.uploadImage(null, name);
      ventaRequest.setImagenTicket(name);
    }
    ventaRequest.setTienda(tvTienda.getText().toString());
    // return null if the user can go to the next step, create a new VerificationError instance
    // otherwise
    return null;
  }
